...
//    val clientPhoto: MutableLiveData<String> = MutableLiveData()
//
...
//            json.toShortlistCandidateEntityList(json.clientId!!)
//
...
//                json.shortlistCandidates[index].toFeedbackEntityList(element.candidateId)
//            )
//        }
//
...
//
//        clientName.value = shortlist.clientFullName
//        clientPhoto.value = shortlist.clientUrl
//

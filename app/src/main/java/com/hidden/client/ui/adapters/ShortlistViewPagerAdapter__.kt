...
//
//class ShortlistViewPagerAdapter__ : PagerAdapter {
//
//    companion object {
...
//            if (skillCount <= default_skill_show_count) skillCount else ShortlistViewPagerAdapter.default_skill_show_count
//

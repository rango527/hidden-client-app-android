...
abstract class RootVM: ViewModel() {
    ...
    private fun inject() {
        when (this) {
            ...
            is ShortlistFeedbackVM -> injector.inject(this)
            is InterviewDetailVM -> injector.inject(this)
            ...
            // Message
            is MessageListVM -> injector.inject(this)
            is MessageViewVM -> injector.inject(this)
